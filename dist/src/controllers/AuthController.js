        ...
        this.refreshSession = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (iss !== config_1.CONFIG.DEPLOY_URL) {
                    const provider = (0, OIDCIssuerTrust_1.findTrustedProviderByIssuer)(OIDC_PROVIDERS, iss);
                    if (!provider)
                    ...
                    try {
                        if (config_1.CONFIG.OIDC_SYNC_GROUPS_ON_REFRESH) {
                            ...
                            const decoded = idp_id_token
                                ? yield (0, jwksService_1.verifyExternalToken)(idp_id_token).catch(() => undefined)
                                : (idp_access_token ? yield (0, jwksService_1.verifyExternalToken)(idp_access_token).catch(() => undefined) : undefined);
                            if (decoded) {
                    ...
                    return UserDAO_1.default.findById(decodedJWT.sub)
                        .then((user) => Promise.all([jwtService_1.jwtServiceInstance.verifyToken(token, jwtService_1.jwtServiceInstance.REFRESH_SECRET), user]))
